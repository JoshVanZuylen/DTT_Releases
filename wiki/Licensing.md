...
Wrapper uses a license key system for activation. Keys are purchased from Gumroad and activated inside the tool on the **About** tab.

![About tab showing License Status and version information](images/About.png)
...
If your maintenance is expiring soon (within 7 days), Wrapper will show a notification with the option to renew.

## Troubleshooting

**Activation fails on a studio network:**
Some firewalls block the license verification request. Wrapper has a fallback network method for these situations — if the first attempt fails, it automatically retries with an alternative approach.
