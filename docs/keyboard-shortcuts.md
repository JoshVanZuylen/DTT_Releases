...
| Action | Control |
|--------|---------|
| Flip on U-axis | Click Flip |
| Flip on V-axis | Shift + click Flip |
| Nudge positive | Click Nudge |
| Nudge negative | Right-click Nudge |
| Nudge on V-axis | Shift + click Nudge |
| Scale up | Click Scale |
| Scale down | Right-click Scale |
| Scale on V-axis | Shift + click Scale |
